...
Figure 2 shows estimated CNDD vs. abundance per species from the Ricker model and the offset-power model for real data from the tropical BCI plot and for simulated data with varying spatial association between adults and recruits. In the second row of the plot, we depict how bias arises in the Ricker and the offset-power model, respectively.  
...
Run analyses with simulated data using the specifications by LaManna
```{r, warning = F}

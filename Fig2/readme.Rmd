...
```{r, warning = F}
fig2 = runAnalyses(abundanceDist = bci[1:10]*12, numQuadrats= 5000, dispersal = c(0, 0.4, 0.8, Inf))
```
...
```{r, warning = F}
fig2[[6]] = runAnalysis(abundanceDist=bci[1:10]*12, numQuadrats= 5000, dispersal = 0.1, theta = 1, adultSurvival = "LaManna")

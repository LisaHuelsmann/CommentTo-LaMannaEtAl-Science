...
The data were requested at http://www.forestgeo.si.edu/. In accordance with LaManna et al., we used the 7th survey at BCI from http://ctfs.si.edu/ctfsrep. 

*Note that we cannot provide the original dataset in the github repository due to the data sharing agreement of the BCI data.*
